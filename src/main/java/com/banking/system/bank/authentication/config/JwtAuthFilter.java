...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private AuthenticationUserDetailService userInfoUserDetailService;

    @Override
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        logger.info("beggining of internal filtration");
        ...
        if(userId!=null && SecurityContextHolder.getContext().getAuthentication()==null){
            UserDetails userDetails = userInfoUserDetailService.loadUserByUsername(userId);
        ...
        logger.info("ending of internal filtration");
    }
}
